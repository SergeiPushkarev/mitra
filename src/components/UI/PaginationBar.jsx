    ...
    <Pagination className='align-self-center' >
      {
        pagesAr.map(pageNumber => 
          ...
          if(pageNumber === "ELLIPSISLEFT") return (<Pagination.Ellipsis key={pageNumber} onClick={()=>setShowedPage(1)}/>);
          if(pageNumber === "ELLIPSISRIGHT") return (<Pagination.Ellipsis key={pageNumber} onClick={()=>setShowedPage(totalPages)}/>);
